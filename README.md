...
This should be saved into `.product-story.md` for reuse.
...
Page structure changes by product type and buyer psychology:
...
Before publishing this repository, make sure you have:

- a chosen open-source license
- a short repo description
- a clear disclaimer about transfer learning vs brand cloning
- at least one more example from a second product category
...
`StorySurface: skills and design methodology for building premium product-story landing pages with AI.`
