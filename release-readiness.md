...
- `product-story-design/references/iphone-family-patterns.md`
...
- `product-story-design/references/hero-patterns.md`
- `product-story-design/references/product-page-patterns.md`
- `product-story-hero/SKILL.md`
...
Some files that the skills and README now rely on are still untracked.
...
- methodology quality: ready or near-ready
...
- one release-candidate review pass away from publishable
...
3. Confirm `examples/` stays local-only
